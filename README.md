...
## Open Source
**[FunAudioLLM/CosyVoice #1872](https://github.com/FunAudioLLM/CosyVoice/pull/1872)** — llama-cpp-python backend для CosyVoice3.  
Интеграция GGUF-инференса через llama-cpp-python: ~2.6x ускорение RTF на T4 vs PyTorch fp16. Конвертер и кванты: [HuggingFace](https://huggingface.co/Ferraronp/CosyVoice3-qwen2.5-0.5b-speech-gguf).
